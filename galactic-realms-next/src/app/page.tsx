  ...
  return (
    ...
    >
      <Suspense fallback={<Spinner />}>
        <Banner />
        {/* About section */}
        <div className="grid grid-rows-3 grid-flow-col gap-10 mt-12 mb-12">
          <div className="row-span-3 col-span-3 sm:col-span-2">
            <img
          ...
          <div className="row-span-2 col-span-1">
            <div>
              <p style={{ textAlign: "justify", fontSize: "20px" }}>
                ...
                placement system, as well as the space lanes and star systems
                are adaptations of Carcassonne mechanics. We mixed those
                mechanics with the hexagonal tiles of Cascadia and the space
                aesthetics of Stellaris. We then built on top of the combination
                of concepts by adding our own new mechanics in the form of
                cosmic tokens which augment the mechanics we adapted from the
                other games
              </p>
            </div>
          </div>
