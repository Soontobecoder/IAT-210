  ...
  return (
    ...
    >
      ...
      <div className="grid grid-flow-row row-span-2 mb-12">
        ...
        <div>
          <p>
            &emsp;Each player chooses a colour, and takes the 6 Starships of that colour.
      ...
      <div className="grid grid-flow-row row-span-2 mb-12">
        ...
        <div>
          <p>
            &emsp;Before diving into the explanation of this game, you should know what the goal is in Galactic Realms.
      ...
      <div className="grid grid-flow-row row-span-2 mb-12">
        ...
        <div className="mb-5">
          <p>
            &emsp;A game of Galactic Realms is played in clockwise order.
        ...
        <div>
          ...
          <ul className="pl-10 list-disc">
            ...
            <li>After all 6 tiles directly adjacent to a Military Station tile are placed, you score 7 points, 1 for each tile adjacent to the Military Station, and 1 for the Military Station itself.
              Then return your Starship to your supply. t</li>
          </ul>
        </div>
      </div>
      ...
      <div className="grid grid-flow-row row-span-2 mb-12">
        ...
        <div>
          <p>
            &emsp;Space Lanes and Star Systems can only have multiple Starships on them if those Starships started out on separate features, and the placement of a
            tile then connected those previously disconnected features.
          </p>
          <p>
            &emsp;During scoring, in the case where more than one player has Starships on a feature, the player with the most Starships on that feature is awarded all of
          ...
          <p>
            &emsp;For the sake of determining how many Starships a player has on the feature, powered up Starships (those with a Cosmic Token beneath them) are worth 2 Starships.
      ...
      <div className="grid grid-flow-row row-span-2 mb-12">
        ...
        <div>
          <p>
            &emsp;You may only place a Starship on your turn, after placing a Space Tile, and only onto a valid feature on that Space Tile. You may not place it on a feature if that
      ...
      <div className="grid grid-flow-row row-span-2 mb-12">
        ...
        <div>
          <p>
            &emsp;If you complete a feature (Space Lane, Star System, Military Station), you gain a Cosmic Token regardless of whether you scored any points for that feature.
      ...
      <div className="grid grid-flow-row row-span-2 mb-12">
        ...
        <div>
          <p>
            &emsp;You may only place Starships if you have any remaining. If you run out of Starships you must wait for features with your Starships to
      ...
      <div className="grid grid-flow-row row-span-2 mb-12">
        ...
        <div>
          <p>
            &emsp;The game ends immediately after the turn of the player who placed the last tile. Then,
            players proceed to perform the final scoring, after which the winner will be known to all!
          </p>
          <p>&emsp;Once the game is over, all incomplete features which have a Starship on them are scored following slightly modified scoring rules:</p>
          <ul className="pl-10 list-disc">
